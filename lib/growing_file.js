...
GrowingFile.prototype._readUntilEof = function() {
  ...
  this._stream.on('open', this._handleOpen.bind(this));
  this._stream.on('pipe', this._handlePipe.bind(this));
};

GrowingFile.prototype._retryInInterval = function() {
  clearTimeout(this._timer);
  this._timer = setTimeout(this._readUntilEof.bind(this), this._interval);
...
GrowingFile.prototype._handleOpen = function(fd) {
  this.emit('open', fd);
};

GrowingFile.prototype._handlePipe = function() {
  this.emit('pipe');
};
